...
function WatchPage2({light, setLight}) {
  ...
  return (
    <section className="section-watch">
      ...
      <div className="server-switch">
        <button onClick={handleOffLight}>
          {!light ? "Tắt đèn" : "Bật đèn"}
        </button>
      </div>
      <div style={light ? {visibility: "hidden"} : {}}>
        ...
        <div className="section">
          <div className="container">
            ...
            <div className="comments-section">
              ...
              {content.map((item) => {
                return <Comment key={item.name} comment={item} />;
              })}
            </div>
          </div>
        </div>
